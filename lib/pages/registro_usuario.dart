...
//           backgroundColor:
//               MaterialStateProperty.all(Color.fromARGB(255, 21, 61, 114)),
//         ),
//         child: const Row(
...
//                     usuario.email ==
//                     emailController
//                         .text, // Devuelve null si no se encuentra un usuario con el email,
//                 orElse: () => Usuario(
//                       email: "",
//                       nombre: "",
//                       password: "",
...
//                 SnackBar(
//                     content: Container(
//                       height: 60, // Ajusta la altura a tu preferencia
//                       child: Center(
//                         child: Text(
//                           'El correo no está registrado',
//                           style: TextStyle(
//                               fontSize: 25), // Ajusta el tamaño de fuente
//                         ),
//                       ),
//                     ),
...
//           padding: MaterialStateProperty.all(EdgeInsets.all(16.0)),
//           backgroundColor:
//               MaterialStateProperty.all(Color.fromARGB(255, 21, 114, 21)),
//         ),
//         child: const Text(
//           'Register',
//           style: TextStyle(
